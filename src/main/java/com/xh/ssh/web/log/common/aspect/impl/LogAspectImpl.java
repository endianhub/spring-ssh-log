...
import com.xh.ssh.web.log.common.annotation.AfterThrowingAspect;
import com.xh.ssh.web.log.common.annotation.AroundAspect;
import com.xh.ssh.web.log.common.aspect.ILogAspect;
...
public class LogAspectImpl implements ILogAspect {
	 ...
	 * 
	 */
	@Pointcut("@annotation(com.xh.ssh.web.log.common.annotation.BeforAspect)")
	private void beforAspect() {
	}

	@Pointcut("@annotation(com.xh.ssh.web.log.common.annotation.AroundAspect)")
	private void aroundAspect() {
	}

	@Pointcut("@annotation(com.xh.ssh.web.log.common.annotation.AfterAspect)")
	private void afterAspect() {
	}

	@Pointcut("@annotation(com.xh.ssh.web.log.common.annotation.AfterThrowingAspect)")
